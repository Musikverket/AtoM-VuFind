...
| part_of_archive_str        |                                                                           |                        |                         | Title of archive (top record) that the record is included in. Same as hierarchy_top_title except is not applied to the top records themselves. |
| reference_code_str         | @countrycode-@repositorycode-did/unitid                                   | Reference code         | Referenskod             |                                                                                                                                                |
| level_of_description_str   | /ead/archdesc/@level                                                      | Level of description   | Beskrivningsnivå        | To disambiguate for translation purposes, 'collection' now becomes 'collection_atom' in this field.                                            |
...
| order_url_str              | mailto:specialsamlingar@musikochteaterbiblioteket.se?subject=did/unitid   | Order                  | Beställ                 |                                                                                                                                                |
...
* title_in_hierarchy
  * Here we add description levels with a baked-in translation to Swedish
